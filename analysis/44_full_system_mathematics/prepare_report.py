...
fig,ax=plt.subplots(figsize=(6.8,3.9));ax.plot([r['rho'] for r in a],[100*r['adaptive_deficit'] for r in a],marker='o');ax.axhspan(30.3,39.7,alpha=.12,label='Experimental mean ± reported SE')
