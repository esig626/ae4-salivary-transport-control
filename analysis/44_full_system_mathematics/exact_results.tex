...
Palk law actually selected in Task 40 is
\begin{equation}
...
\end{align*}
Thus, with the exact printed Cha constants selected by production,
\[
...
\begin{align*}
 ...
 \qquad \delta_{a,b}=P_{\mathrm{CO}_2,a,b}C_0/J_0.
\end{align*}
Here $\psi_b=V_b/V_T$, $V_T=RT/F$, and $u$ is the frozen NBC calcium
...
\[
 \widehat K_a=g_{K,a}(\psi_a-e_{K,il}),\quad
 \widehat K_b=g_{K,b}(\psi_b-e_{K,ie}),\quad
 \widehat C_a=-g_{C,a}(\psi_a-e_{\mathrm{Cl},il}),\quad
