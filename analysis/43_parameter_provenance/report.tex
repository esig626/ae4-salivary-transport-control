...
The additional file \path{output/numerical_controls.json} records the production integration specification, conservation tolerances, pH inversion tolerances and voltage bracket. In particular, $[-0.5,0.5]$ V is the implemented voltage search bracket and not a measured physiological voltage interval. Exact unit conversions are stated separately from physiological settings.
