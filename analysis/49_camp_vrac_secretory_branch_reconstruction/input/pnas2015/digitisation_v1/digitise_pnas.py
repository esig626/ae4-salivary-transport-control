...
for t in range(25,451,25):
 ...
 # Lower bound follows a wide predeclared upper-curve corridor; CCh excluded.
 corridor_centre=float(np.interp(t,[0,50,100,150,200,250,300,350,400,450],[174,185,177,158,139,122,105,88,76,69]))
 high=max(58,int(corridor_centre-10));low=int(corridor_centre+10)
...
meta={'article_doi':'10.1073/pnas.1415739112','pmcid':'PMC4343136','extraction_date':'2026-09-16',
 ...
 'figure5C_corridor':{'time_s':[0,50,100,150,200,250,300,350,400,450],'y_px':[174,185,177,158,139,122,105,88,76,69],'halfwidth_px':10,'minimum_y_px':58,'dark_threshold':150,'strip_width_px':3},
